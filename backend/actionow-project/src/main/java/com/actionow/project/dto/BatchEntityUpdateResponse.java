...
public class BatchEntityUpdateResponse {
    ...
    public static class EntityUpdateResult {
        ...
        public static EntityUpdateResult success(int index, CanvasEntityUpdateResponse response) {
            return EntityUpdateResult.builder()
                    .index(index)
                    .success(true)
        ...
        public static EntityUpdateResult failed(int index, String entityId, String entityType, String errorMessage) {
            return EntityUpdateResult.builder()
                    .index(index)
                    .success(false)
                    .entityId(entityId)
